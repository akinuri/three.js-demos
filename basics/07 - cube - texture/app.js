...
/* ============================== ORBIT ============================== */
/*
  Note: some import/export functionality has been disabled to allow local testing, ie: file:///
   * disabled import and export in OrbitControls.js
   * disabled export in three.module.js
*/
...
var plane = new THREE.Mesh(
    ...
    new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture("images/concrete-512.jpg"), side: THREE.DoubleSide })
);
...
var cube = new THREE.Mesh(
    ...
    new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture("images/crate-512.jpg") })
);
cube.position.y = 0.5;
